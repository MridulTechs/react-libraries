...
| React Admin  | A frontend Framework for building B2B applications running in the browser on top of REST/GraphQL APIs, using ES6, React and Material Design | [Github](https://github.com/marmelab/react-admin) | [Guides](https://github.com/marmelab/react-admin#installation) | [Docs](https://marmelab.com/react-admin/Tutorial.html) |
...
| Name | Description | Repository | Installation | Docs |
|---|---|---|---|---|
| Curi | JavaScript router for single-page applications | [Github](https://github.com/pshrmn/curi) | [Guides](https://curi.js.org/guides/installation/) | [Docs](https://curi.js.org/guides/react-dom/) |
...
| Evergreen | 🌲 Evergreen React UI Framework by Segment | [Github](https://github.com/segmentio/evergreen) | [Guides](https://evergreen.segment.com/introduction/getting-started) | [Docs](https://evergreen.segment.com/) |
| Fluent UI | A set of React components for building Microsoft web experiences | [Github](https://github.com/microsoft/fluentui/tree/master/packages/react) | [Guides](https://developer.microsoft.com/en-us/fluentui#/get-started/web) | [Docs](https://developer.microsoft.com/en-us/fluentui#/controls/web) |
| Grommet | A react-based framework that provides accessibility, modularity, responsiveness, and theming in a tidy package | [Github](https://github.com/grommet/grommet) | [Guides](https://github.com/grommet/grommet#install) | [Docs](https://v2.grommet.io/components) |
